...
<body>
	<form method="post" action="insertDo.jsp">
		...
		<td class="content"><input type="password" name="password" id="password" size="10" maxlength="20" requierd>
		</td>
		</tr>
		<tr>
		...
		<tr>
		<td colspan="2" align="center"><input type="submit" value="입력완료"><input type="reset" value="다시작성"></td>
		</tr>
		</table>
	</form>
</body>
